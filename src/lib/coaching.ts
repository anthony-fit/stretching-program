...
export const COACH_PROFILES: CoachProfile[] = [
  {
    ...
    philosophy:
      "I focus on the structural mechanics of high-quality movement. Every rep is an investment in your future strength.",
  ...
  },
  {
    ...
    philosophy:
      "Movement should be a dialogue with your body, not an argument. We prioritize nervous system regulation and deep restoration.",
  ...
  },
  {
    ...
    philosophy:
      "Range of motion is the foundation of longevity. We build fluid, adaptable strength that serves you in every environment.",
  ...
  },
  {
    ...
    philosophy:
      "Plateaus are just temporary boundaries. We use intensity to redefine what you think is possible today.",
