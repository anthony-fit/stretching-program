...
// .wrangler/tmp/pages-WFMfWU/functionsWorker-0.8128726203788299.mjs
...
__name(getAI, "getAI");
__name2(getAI, "getAI");
async function generateCompositionBlueprintViaLLM(apiKey, prefs, exerciseDatabaseSummary) {
...
async function generateRoutineScript(apiKey, exercises, goal, creatorMode, context) {
  const client = getAI(apiKey);
  const prompt = `
...
async function generateSEOMetadata(apiKey, exercises, goal, context) {
  const client = getAI(apiKey);
  const prompt = `
...
async function generateSocialCaptions(apiKey, exercises, goal, creatorMode, context) {
  const client = getAI(apiKey);
  const prompt = `
...
// .wrangler/tmp/bundle-TFSSmX/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-TFSSmX/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8128726203788299.js.map
